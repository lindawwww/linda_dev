...
var onProductBtnClick = function ( t, opts ){
	...
	.then( function( productCard ) {
		$.getJSON("https://trello.com/1/cards/SukF4Irl/actions?key=b1cc5bee67e2cfc80d86fe30ad1d46bf&token=84f11f74eebf02e2c1e195f17f9015b7402d96fb149beac9d27786dc6e41071e", function(data) {
			var ulObj = $("#demo");
			var id = data.id;
			console.log(id);
		});
